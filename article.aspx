<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="article.aspx.cs" Inherits="Limon_Studio.article" %>
        ...
        ****************************************************************************-->
          ...
          ****************************************************************************-->
                    ...
                    <div class="article_dis">
                        <ul>
                            <asp:DataList ID="DL_article" runat="server">
                                <ItemTemplate>
                                    <li><a href="essay.aspx?id=<%# Eval("A_ID") %>"><%# stringformat(Eval("A_Title").ToString(), 50) %></a>
                                        <span style="float:right;">今日</span></li>
                                </ItemTemplate>
                            </asp:DataList>
                        </ul>
                    </div>
          ...
          ****************************************************************************-->
                    ...
                    <nav>
                        <ul>
                            ...
                            <li class="click_on"><a href="article.aspx" title="Link">文章</a></li>
