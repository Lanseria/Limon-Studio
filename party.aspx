<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="party.aspx.cs" Inherits="Limon_Studio.party" %>
    ...
    <div id="content">
        ...
        <section id="mainContent">
          ...
          ****************************************************************************-->
            ...
            <h3>电子信息</h3>
            <img style="width:140%;" src="image/dboCLass/电子信息.png"/>
            <h3>软件工程</h3>
            <img style="width:140%;" src="image/dboCLass/软件工程.png"/>
            <h3>通信工程</h3>
            <img style="width:140%;" src="image/dboCLass/通信工程.png"/>
            <h3>计算机</h3>
            <img style="width:140%;" src="image/dboCLass/计算机.png"/>
            <aside id="authorInfo">
          ...
          ****************************************************************************-->
            ...
            <nav>
                <ul>
                    ...
                    <li class="click_on"><a href="party.aspx" title="Link">活动</a></li>
